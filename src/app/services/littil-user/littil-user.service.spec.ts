...
describe('LittilUserService', () => {
  ...
  describe('getById', () => {
    it('should get user by id', () => {
      ...
      spectator.expectOne(baseUrl + 'api/v1/users/123', HttpMethod.GET);
    });
  });
  ...
  describe('getAll', () => {
    it('should get all users', () => {
      ...
      spectator.expectOne(baseUrl + 'api/v1/users', HttpMethod.GET);
    });
  });
  ...
  describe('create', () => {
    it('should create new teacher', () => {
      spectator.service
        ...
        .subscribe();
      spectator.expectOne(baseUrl + 'api/v1/users', HttpMethod.POST);
    });
  });
  ...
  describe('delete', () => {
    it('should delete user', () => {
      ...
      spectator.expectOne(baseUrl + 'api/v1/users/123', HttpMethod.DELETE);
    });
  });
});
